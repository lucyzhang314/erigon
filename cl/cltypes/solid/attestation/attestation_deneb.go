...
var _ Attestation = (*AttestationDeneb)(nil)
...
// AttestationDeneb type represents a statement or confirmation of some occurrence or phenomenon.
type AttestationDeneb struct {
...
func (*AttestationDeneb) Static() bool {
	return false
}

func (a *AttestationDeneb) Copy() Attestation {
	new := &AttestationDeneb{}
...
func (a AttestationDeneb) MarshalJSON() ([]byte, error) {
...
func (a *AttestationDeneb) UnmarshalJSON(buf []byte) error {
	var tmp struct {
		AggregationBits hexutility.Bytes  `json:"aggregation_bits"`
		Signature       libcommon.Bytes96 `json:"signature"`
		Data            AttestationData   `json:"data"`
...
func (a *AttestationDeneb) AggregationBits() []byte {
...
func (a *AttestationDeneb) SetAggregationBits(bits []byte) {
...
func (a *AttestationDeneb) DecodeSSZ(buf []byte, _ int) error {
...
func (a *AttestationDeneb) EncodeSSZ(dst []byte) ([]byte, error) {
	buf := dst
...
func (a *AttestationDeneb) CopyHashBufferTo(o []byte) error {
	for i := 0; i < 128; i++ {
		o[i] = 0
	}
...
func (a *AttestationDeneb) HashSSZ() (o [32]byte, err error) {
...
func (a *AttestationDeneb) Clone() clonable.Clonable {
	if a == nil {
		return &AttestationDeneb{}
	}

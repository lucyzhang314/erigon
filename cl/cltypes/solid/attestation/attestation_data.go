...
func (a AttestationData) MarshalJSON() ([]byte, error) {
	return json.Marshal(struct {
		...
		Source          solid.Checkpoint `json:"source"`
		Target          solid.Checkpoint `json:"target"`
	}{
		Slot:            a.Slot(),
...
func (a AttestationData) UnmarshalJSON(buf []byte) error {
	...
	tmp.Source = solid.NewCheckpoint()
	tmp.Target = solid.NewCheckpoint()
...
func (a AttestationData) Source() solid.Checkpoint {
	return solid.Checkpoint(a[48:88])
}

func (a AttestationData) Target() solid.Checkpoint {
	return solid.Checkpoint(a[88:128])
}
...
func (a AttestationData) SetSource(c solid.Checkpoint) {
	copy(a[48:88], c)
}

func (a AttestationData) SetTarget(c solid.Checkpoint) {
	copy(a[88:128], c)
}

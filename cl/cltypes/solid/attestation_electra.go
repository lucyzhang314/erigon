...
var _ Attestation = (*AttestationElectra)(nil)

// AttestationElectra type represents a statement or confirmation of some occurrence or phenomenon.
...
func (*AttestationElectra) Static() bool {
	return false
}

func (a *AttestationElectra) Copy() Attestation {
	new := &AttestationElectra{}
...
func (a AttestationElectra) MarshalJSON() ([]byte, error) {
...
func (a *AttestationElectra) UnmarshalJSON(buf []byte) error {
	var tmp struct {
		AggregationBits hexutility.Bytes  `json:"aggregation_bits"`
		Signature       libcommon.Bytes96 `json:"signature"`
		Data            AttestationData   `json:"data"`
...
func (a *AttestationElectra) AggregationBits() []byte {
...
func (a *AttestationElectra) SetAggregationBits(bits []byte) {
...
func (a *AttestationElectra) DecodeSSZ(buf []byte, _ int) error {
...
func (a *AttestationElectra) EncodeSSZ(dst []byte) ([]byte, error) {
	buf := dst
...
func (a *AttestationElectra) CopyHashBufferTo(o []byte) error {
	for i := 0; i < 128; i++ {
		o[i] = 0
	}
...
func (a *AttestationElectra) HashSSZ() (o [32]byte, err error) {
...
func (a *AttestationElectra) Clone() clonable.Clonable {
	if a == nil {
